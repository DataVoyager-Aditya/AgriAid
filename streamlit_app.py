...
class TransferResNet50(nn.Module):
    def __init__(self, num_classes):
        ...
        # Load ResNet50 base weights from local file (not from the internet)
        BASE_DIR = os.path.dirname(os.path.abspath(__file__))
        resnet_weights_path = os.path.join(BASE_DIR, "models", "resnet50-0676ba61.pth")

        self.base_model = models.resnet50(weights=None)
        self.base_model.load_state_dict(torch.load(resnet_weights_path, map_location="cpu"))
        ...
        # Replace FC layer for custom classification
